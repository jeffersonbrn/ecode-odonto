 ...
 */
class DevolvidosForm extends TPage
{
    private $form; // form
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_DevolvidosForm');
        ...
        $datadevolucao->setMask('dd/mm/yyyy');
        ...
        $this->form->addFields( [new TLabel('Data Devolução')], [$datadevolucao] );
        ...
        $this->form->addActionLink('Listar a Devolver',  new TAction(['DevolucaoList', 'onReload']), 'fa:table blue');
        
        // wrap the page content using vertical box
        $vbox = new TVBox;
        $vbox->style = 'width: 100%';
        $vbox->add(new TXMLBreadCrumb('menu.xml', 'DevolvidosList'));
        $vbox->add($this->form);
        parent::add($vbox);
    }
    /**
